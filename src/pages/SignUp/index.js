...
function SignUp() {
    ...
    const handleSignUpSuccess = () => {
        navigate('/sign-up/onboarding')
    }

    return (
        <div className={cx('sign-up-page')}>
            <div className={cx('sign-up-choice')}>
                <div className={cx('sign-up-title')}>
                    <h1>Welcome</h1>
                    <p>Sign up to start</p>
                </div>
                <div className={cx('sign-up-button-wrapper')}>
                    <div className={cx('sign-up-buttons')}>
                        <div
                            className={cx(
                                'sign-up-button-item',
                                'sign-up-button-item--box-shadow'
                            )}
                        >
                            <div className={cx('sign-up-button-item__svg')}>
                                <svg
                       ...
                       C98.3,33.2,87.3,29,75.9,29.1c-17.4,0-33.2,9.8-41,25.3l15.2,11.8C53.8,55.3,63.9,47.3,75.9,47.3z"
                            ...
                            <div className={cx('sign-up-button-item__title')}>
        ...
        `}
            ...
            <div className={cx('sign-up-input-wrapper')}>
                <div className={cx('sign-up-input-box')}>
                    <form onSubmit={handleSignUpSuccess}>
                        ...
                        <div className={cx('sign-up-input')}>
                            <input type="password" placeholder="Complete Password" />
                        </div>
                        <Link className={cx('to-sign-in')} to='/login'>Have account? Sign in!</Link>
                        <button
                            className={cx('sign-up-input-button')}
                            type="submit"
                        >
                            Continue
                        </button>
